...
excerpt: "N'emportez pas tout votre placard pour une semaine. Voici comment construire une garde-robe de voyage stylee."
---
...
1. **Does it match at least three other items in the pile?** If not, remove it or replace it with something that does.
2. **Does it serve a specific purpose on this trip?** "Just in case" items almost never get worn. Be ruthless.
3. **Is it appropriate for the actual weather forecast?** Not the average climate — the forecast for the specific days you'll be there.
